...
@class WCRedEnvelopesControlLogic; @class UIViewController; @class WCRedEnvelopesReceiveHomeView; @class WCDeviceStepObject; @class CMessageMgr; @class BaseMsgContentViewController; @class UINavigationController; @class MicroMessengerAppDelegate; @class MMMsgLogicManager; @class MMUIWindow; @class OnlineDeviceInfoViewController; @class NewMainFrameViewController; 
